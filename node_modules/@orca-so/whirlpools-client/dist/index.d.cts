import { ReadonlyUint8Array, Address, Encoder, Decoder, Codec, EncodedAccount, Account, MaybeEncodedAccount, MaybeAccount, fetchEncodedAccount, FetchAccountConfig, fetchEncodedAccounts, FetchAccountsConfig, SolanaError, SOLANA_ERROR__INSTRUCTION_ERROR__CUSTOM, IAccountMeta, IInstruction, IInstructionWithData, IInstructionWithAccounts, WritableAccount, ReadonlyAccount, ReadonlySignerAccount, IAccountSignerMeta, TransactionSigner, Option, OptionOrNullable, WritableSignerAccount, Rpc, GetProgramAccountsApi, GetProgramAccountsMemcmpFilter, ProgramDerivedAddress } from '@solana/web3.js';

declare const FEE_TIER_DISCRIMINATOR: Uint8Array;
...
declare const POSITION_DISCRIMINATOR: Uint8Array;
...
declare const POSITION_BUNDLE_DISCRIMINATOR: Uint8Array;
...
declare const TICK_ARRAY_DISCRIMINATOR: Uint8Array;
...
declare const TOKEN_BADGE_DISCRIMINATOR: Uint8Array;
...
declare const WHIRLPOOL_DISCRIMINATOR: Uint8Array;
...
declare const WHIRLPOOLS_CONFIG_DISCRIMINATOR: Uint8Array;
...
declare const WHIRLPOOLS_CONFIG_EXTENSION_DISCRIMINATOR: Uint8Array;
...
declare enum WhirlpoolInstruction {
    ...
    CollectFeesV2 = 33,
    CollectProtocolFeesV2 = 34,
    CollectRewardV2 = 35,
    DecreaseLiquidityV2 = 36,
    IncreaseLiquidityV2 = 37,
    InitializePoolV2 = 38,
    InitializeRewardV2 = 39,
    SetRewardEmissionsV2 = 40,
    SwapV2 = 41,
    TwoHopSwapV2 = 42,
    InitializeConfigExtension = 43,
    SetConfigExtensionAuthority = 44,
    SetTokenBadgeAuthority = 45,
    InitializeTokenBadge = 46,
    DeleteTokenBadge = 47
}
...
declare const CLOSE_BUNDLED_POSITION_DISCRIMINATOR: Uint8Array;
...
declare const CLOSE_POSITION_DISCRIMINATOR: Uint8Array;
...
declare const CLOSE_POSITION_WITH_TOKEN_EXTENSIONS_DISCRIMINATOR: Uint8Array;
...
declare const COLLECT_FEES_DISCRIMINATOR: Uint8Array;
...
declare const COLLECT_FEES_V2_DISCRIMINATOR: Uint8Array;
...
declare const COLLECT_PROTOCOL_FEES_DISCRIMINATOR: Uint8Array;
...
declare const COLLECT_PROTOCOL_FEES_V2_DISCRIMINATOR: Uint8Array;
...
declare const COLLECT_REWARD_DISCRIMINATOR: Uint8Array;
...
declare const COLLECT_REWARD_V2_DISCRIMINATOR: Uint8Array;
...
declare const DECREASE_LIQUIDITY_DISCRIMINATOR: Uint8Array;
...
declare const DECREASE_LIQUIDITY_V2_DISCRIMINATOR: Uint8Array;
...
declare const DELETE_POSITION_BUNDLE_DISCRIMINATOR: Uint8Array;
...
declare const DELETE_TOKEN_BADGE_DISCRIMINATOR: Uint8Array;
...
declare const INCREASE_LIQUIDITY_DISCRIMINATOR: Uint8Array;
...
declare const INCREASE_LIQUIDITY_V2_DISCRIMINATOR: Uint8Array;
...
declare const INITIALIZE_CONFIG_DISCRIMINATOR: Uint8Array;
...
declare const INITIALIZE_CONFIG_EXTENSION_DISCRIMINATOR: Uint8Array;
...
declare const INITIALIZE_FEE_TIER_DISCRIMINATOR: Uint8Array;
...
declare const INITIALIZE_POOL_DISCRIMINATOR: Uint8Array;
...
declare const INITIALIZE_POOL_V2_DISCRIMINATOR: Uint8Array;
...
declare const INITIALIZE_POSITION_BUNDLE_DISCRIMINATOR: Uint8Array;
...
declare const INITIALIZE_POSITION_BUNDLE_WITH_METADATA_DISCRIMINATOR: Uint8Array;
...
declare const INITIALIZE_REWARD_DISCRIMINATOR: Uint8Array;
...
declare const INITIALIZE_REWARD_V2_DISCRIMINATOR: Uint8Array;
...
declare const INITIALIZE_TICK_ARRAY_DISCRIMINATOR: Uint8Array;
...
declare const INITIALIZE_TOKEN_BADGE_DISCRIMINATOR: Uint8Array;
...
declare const OPEN_BUNDLED_POSITION_DISCRIMINATOR: Uint8Array;
...
declare const OPEN_POSITION_DISCRIMINATOR: Uint8Array;
...
declare const OPEN_POSITION_WITH_METADATA_DISCRIMINATOR: Uint8Array;
...
declare const OPEN_POSITION_WITH_TOKEN_EXTENSIONS_DISCRIMINATOR: Uint8Array;
...
declare const SET_COLLECT_PROTOCOL_FEES_AUTHORITY_DISCRIMINATOR: Uint8Array;
...
declare const SET_CONFIG_EXTENSION_AUTHORITY_DISCRIMINATOR: Uint8Array;
...
declare const SET_DEFAULT_FEE_RATE_DISCRIMINATOR: Uint8Array;
...
declare const SET_DEFAULT_PROTOCOL_FEE_RATE_DISCRIMINATOR: Uint8Array;
...
declare const SET_FEE_AUTHORITY_DISCRIMINATOR: Uint8Array;
...
declare const SET_FEE_RATE_DISCRIMINATOR: Uint8Array;
...
declare const SET_PROTOCOL_FEE_RATE_DISCRIMINATOR: Uint8Array;
...
declare const SET_REWARD_AUTHORITY_DISCRIMINATOR: Uint8Array;
...
declare const SET_REWARD_AUTHORITY_BY_SUPER_AUTHORITY_DISCRIMINATOR: Uint8Array;
...
declare const SET_REWARD_EMISSIONS_DISCRIMINATOR: Uint8Array;
...
declare const SET_REWARD_EMISSIONS_SUPER_AUTHORITY_DISCRIMINATOR: Uint8Array;
...
declare const SET_REWARD_EMISSIONS_V2_DISCRIMINATOR: Uint8Array;
...
declare const SET_TOKEN_BADGE_AUTHORITY_DISCRIMINATOR: Uint8Array;
...
declare const SWAP_DISCRIMINATOR: Uint8Array;
...
declare const SWAP_V2_DISCRIMINATOR: Uint8Array;
...
declare const TWO_HOP_SWAP_DISCRIMINATOR: Uint8Array;
...
declare const TWO_HOP_SWAP_V2_DISCRIMINATOR: Uint8Array;
...
declare const UPDATE_FEES_AND_REWARDS_DISCRIMINATOR: Uint8Array;
...
declare function getFeeTierAddress(whirlpoolsConfig: Address, tickSpacing: number): Promise<ProgramDerivedAddress>;
