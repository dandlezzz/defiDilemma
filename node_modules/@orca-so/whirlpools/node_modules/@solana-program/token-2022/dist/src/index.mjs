...
var Token2022Instruction = /* @__PURE__ */ ((Token2022Instruction2) => {
  ...
  Token2022Instruction2[Token2022Instruction2["InitializeMetadataPointer"] = 51] = "InitializeMetadataPointer";
  Token2022Instruction2[Token2022Instruction2["UpdateMetadataPointer"] = 52] = "UpdateMetadataPointer";
  Token2022Instruction2[Token2022Instruction2["InitializeGroupPointer"] = 53] = "InitializeGroupPointer";
  Token2022Instruction2[Token2022Instruction2["UpdateGroupPointer"] = 54] = "UpdateGroupPointer";
  Token2022Instruction2[Token2022Instruction2["InitializeGroupMemberPointer"] = 55] = "InitializeGroupMemberPointer";
  Token2022Instruction2[Token2022Instruction2["UpdateGroupMemberPointer"] = 56] = "UpdateGroupMemberPointer";
  Token2022Instruction2[Token2022Instruction2["InitializeTokenMetadata"] = 57] = "InitializeTokenMetadata";
  Token2022Instruction2[Token2022Instruction2["UpdateTokenMetadataField"] = 58] = "UpdateTokenMetadataField";
  Token2022Instruction2[Token2022Instruction2["RemoveTokenMetadataKey"] = 59] = "RemoveTokenMetadataKey";
  Token2022Instruction2[Token2022Instruction2["UpdateTokenMetadataUpdateAuthority"] = 60] = "UpdateTokenMetadataUpdateAuthority";
  Token2022Instruction2[Token2022Instruction2["EmitTokenMetadata"] = 61] = "EmitTokenMetadata";
  Token2022Instruction2[Token2022Instruction2["InitializeTokenGroup"] = 62] = "InitializeTokenGroup";
  Token2022Instruction2[Token2022Instruction2["UpdateTokenGroupMaxSize"] = 63] = "UpdateTokenGroupMaxSize";
  Token2022Instruction2[Token2022Instruction2["UpdateTokenGroupUpdateAuthority"] = 64] = "UpdateTokenGroupUpdateAuthority";
  Token2022Instruction2[Token2022Instruction2["InitializeTokenGroupMember"] = 65] = "InitializeTokenGroupMember";
...
function identifyToken2022Instruction(instruction) {
  ...
  if (containsBytes(
    ...
    return 57 /* InitializeTokenMetadata */;
  }
  if (containsBytes(
    data,
    ...
    return 58 /* UpdateTokenMetadataField */;
  }
  if (containsBytes(data, new Uint8Array([234, 18, 32, 56, 89, 141, 37, 181]), 0)) {
    return 59 /* RemoveTokenMetadataKey */;
  }
  if (containsBytes(
    data,
    ...
    return 60 /* UpdateTokenMetadataUpdateAuthority */;
  }
  if (containsBytes(
    data,
  ...
  if (containsBytes(
    ...
    return 63 /* UpdateTokenGroupMaxSize */;
  }
  if (containsBytes(
    data,
    ...
    return 64 /* UpdateTokenGroupUpdateAuthority */;
  }
  if (containsBytes(
    data,
    ...
    return 65 /* InitializeTokenGroupMember */;
  }
  throw new Error(
