...
import { type ParsedAmountToUiAmountInstruction, type ParsedApplyConfidentialPendingBalanceInstruction, type ParsedApproveCheckedInstruction, type ParsedApproveConfidentialTransferAccountInstruction, type ParsedApproveInstruction, type ParsedBurnCheckedInstruction, type ParsedBurnInstruction, type ParsedCloseAccountInstruction, type ParsedConfidentialDepositInstruction, type ParsedConfidentialTransferInstruction, type ParsedConfidentialTransferWithFeeInstruction, type ParsedConfidentialWithdrawInstruction, type ParsedConfigureConfidentialTransferAccountInstruction, type ParsedDisableConfidentialCreditsInstruction, type ParsedDisableMemoTransfersInstruction, type ParsedDisableNonConfidentialCreditsInstruction, type ParsedEmitTokenMetadataInstruction, type ParsedEmptyConfidentialTransferAccountInstruction, type ParsedEnableConfidentialCreditsInstruction, type ParsedEnableMemoTransfersInstruction, type ParsedEnableNonConfidentialCreditsInstruction, type ParsedFreezeAccountInstruction, type ParsedGetAccountDataSizeInstruction, type ParsedHarvestWithheldTokensToMintInstruction, type ParsedInitializeAccount2Instruction, type ParsedInitializeAccount3Instruction, type ParsedInitializeAccountInstruction, type ParsedInitializeConfidentialTransferMintInstruction, type ParsedInitializeDefaultAccountStateInstruction, type ParsedInitializeGroupMemberPointerInstruction, type ParsedInitializeGroupPointerInstruction, type ParsedInitializeImmutableOwnerInstruction, type ParsedInitializeMetadataPointerInstruction, type ParsedInitializeMint2Instruction, type ParsedInitializeMintCloseAuthorityInstruction, type ParsedInitializeMintInstruction, type ParsedInitializeMultisig2Instruction, type ParsedInitializeMultisigInstruction, type ParsedInitializeTokenGroupInstruction, type ParsedInitializeTokenGroupMemberInstruction, type ParsedInitializeTokenMetadataInstruction, type ParsedInitializeTransferFeeConfigInstruction, type ParsedMintToCheckedInstruction, type ParsedMintToInstruction, type ParsedReallocateInstruction, type ParsedRemoveTokenMetadataKeyInstruction, type ParsedRevokeInstruction, type ParsedSetAuthorityInstruction, type ParsedSetTransferFeeInstruction, type ParsedSyncNativeInstruction, type ParsedThawAccountInstruction, type ParsedTransferCheckedInstruction, type ParsedTransferCheckedWithFeeInstruction, type ParsedTransferInstruction, type ParsedUiAmountToAmountInstruction, type ParsedUpdateConfidentialTransferMintInstruction, type ParsedUpdateDefaultAccountStateInstruction, type ParsedUpdateGroupMemberPointerInstruction, type ParsedUpdateGroupPointerInstruction, type ParsedUpdateMetadataPointerInstruction, type ParsedUpdateTokenGroupMaxSizeInstruction, type ParsedUpdateTokenGroupUpdateAuthorityInstruction, type ParsedUpdateTokenMetadataFieldInstruction, type ParsedUpdateTokenMetadataUpdateAuthorityInstruction, type ParsedWithdrawWithheldTokensFromAccountsInstruction, type ParsedWithdrawWithheldTokensFromMintInstruction } from '../instructions';
export declare const TOKEN_2022_PROGRAM_ADDRESS: Address<"TokenzQdBNbLqP5VEhdkAS6EPFLC1PHnBqCXEpPxuEb">;
export declare enum Token2022Account {
    Mint = 0,
    Token = 1,
    Multisig = 2
}
export declare function identifyToken2022Account(account: {
    data: ReadonlyUint8Array;
} | ReadonlyUint8Array): Token2022Account;
export declare enum Token2022Instruction {
    InitializeMint = 0,
    InitializeAccount = 1,
    ...
    InitializeTransferFeeConfig = 26,
    TransferCheckedWithFee = 27,
    WithdrawWithheldTokensFromMint = 28,
    WithdrawWithheldTokensFromAccounts = 29,
    HarvestWithheldTokensToMint = 30,
    SetTransferFee = 31,
    InitializeConfidentialTransferMint = 32,
    UpdateConfidentialTransferMint = 33,
    ConfigureConfidentialTransferAccount = 34,
    ApproveConfidentialTransferAccount = 35,
    EmptyConfidentialTransferAccount = 36,
    ConfidentialDeposit = 37,
    ConfidentialWithdraw = 38,
    ConfidentialTransfer = 39,
    ApplyConfidentialPendingBalance = 40,
    EnableConfidentialCredits = 41,
    DisableConfidentialCredits = 42,
    EnableNonConfidentialCredits = 43,
    DisableNonConfidentialCredits = 44,
    ConfidentialTransferWithFee = 45,
    InitializeDefaultAccountState = 46,
    UpdateDefaultAccountState = 47,
    Reallocate = 48,
    EnableMemoTransfers = 49,
    DisableMemoTransfers = 50,
    InitializeMetadataPointer = 51,
    UpdateMetadataPointer = 52,
    InitializeGroupPointer = 53,
    UpdateGroupPointer = 54,
    InitializeGroupMemberPointer = 55,
    UpdateGroupMemberPointer = 56,
    InitializeTokenMetadata = 57,
    UpdateTokenMetadataField = 58,
    RemoveTokenMetadataKey = 59,
    UpdateTokenMetadataUpdateAuthority = 60,
    EmitTokenMetadata = 61,
    InitializeTokenGroup = 62,
    UpdateTokenGroupMaxSize = 63,
    UpdateTokenGroupUpdateAuthority = 64,
    InitializeTokenGroupMember = 65
}
export declare function identifyToken2022Instruction(instruction: {
    data: ReadonlyUint8Array;
} | ReadonlyUint8Array): Token2022Instruction;
